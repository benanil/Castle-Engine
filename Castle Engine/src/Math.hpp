...
// operator overloaders for XMFLOAT types
CE_INLINE XMFLOAT3 operator+(XMFLOAT3 a, XMFLOAT3 b) { return XMFLOAT3(a.x + b.x, a.y + b.y, a.z + b.z); }
CE_INLINE XMFLOAT3 operator-(XMFLOAT3 a, XMFLOAT3 b) { return XMFLOAT3(a.x - b.x, a.y - b.y, a.z - b.z); }
CE_INLINE XMFLOAT3 operator*(XMFLOAT3 a, XMFLOAT3 b) { return XMFLOAT3(a.x * b.x, a.y * b.y, a.z * b.z); }
CE_INLINE XMFLOAT3 operator/(XMFLOAT3 a, XMFLOAT3 b) { return XMFLOAT3(a.x / b.x, a.y / b.y, a.z / b.z); }
CE_INLINE XMFLOAT3 operator+(XMFLOAT3 a, float b) { return XMFLOAT3(a.x + b, a.y + b, a.z + b); }
CE_INLINE XMFLOAT3 operator-(XMFLOAT3 a, float b) { return XMFLOAT3(a.x - b, a.y - b, a.z - b); }
CE_INLINE XMFLOAT3 operator*(XMFLOAT3 a, float b) { return XMFLOAT3(a.x * b, a.y * b, a.z * b); }
CE_INLINE XMFLOAT3 operator/(XMFLOAT3 a, float b) { return XMFLOAT3(a.x / b, a.y / b, a.z / b); }

CE_INLINE XMFLOAT2 operator+(XMFLOAT2 a, XMFLOAT2 b) { return XMFLOAT2(a.x + b.x, a.y + b.y); }
CE_INLINE XMFLOAT2 operator-(XMFLOAT2 a, XMFLOAT2 b) { return XMFLOAT2(a.x - b.x, a.y - b.y); }
CE_INLINE XMFLOAT2 operator*(XMFLOAT2 a, XMFLOAT2 b) { return XMFLOAT2(a.x * b.x, a.y * b.y); }
CE_INLINE XMFLOAT2 operator/(XMFLOAT2 a, XMFLOAT2 b) { return XMFLOAT2(a.x / b.x, a.y / b.y); }
CE_INLINE XMFLOAT2 operator+(XMFLOAT2 a, float b) { return XMFLOAT2(a.x + b, a.y + b); }
CE_INLINE XMFLOAT2 operator-(XMFLOAT2 a, float b) { return XMFLOAT2(a.x - b, a.y - b); }
CE_INLINE XMFLOAT2 operator*(XMFLOAT2 a, float b) { return XMFLOAT2(a.x * b, a.y * b); }
CE_INLINE XMFLOAT2 operator/(XMFLOAT2 a, float b) { return XMFLOAT2(a.x / b, a.y / b); }
